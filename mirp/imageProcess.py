...
def get_supervoxels(
    ...
    #print("1 img_voxel_grid",img_voxel_grid)
    #print("1 np is nan img_voxel_grid",np.isnan(img_voxel_grid).any())

    # Get grey level thresholds
    g_range = settings.roi_resegment.intensity_range
    
    #print("g_range",g_range)
    #print("np.isnan(img_obj.get_voxel_grid())",np.isnan(img_obj.get_voxel_grid()).any())
    #print("np.isnan(roi_obj.roi.get_voxel_grid())",np.isnan(roi_obj.roi.get_voxel_grid()).any())
    #print(np.isnan(img_obj.get_voxel_grid()[roi_obj.roi.get_voxel_grid()]).any())
    #print(img_obj.get_voxel_grid()[roi_obj.roi.get_voxel_grid()])
    #print("np.min(img_obj.get_voxel_grid()[roi_obj.roi.get_voxel_grid()])",np.min(img_obj.get_voxel_grid()[roi_obj.roi.get_voxel_grid()]))
    #print("np.max(img_obj.get_voxel_grid()[roi_obj.roi.get_voxel_grid()])",np.max(img_obj.get_voxel_grid()[roi_obj.roi.get_voxel_grid()]))
    #print("g_range[0] == np.nan",g_range[0] == np.nan)
    #print("g_range[0] is np.nan",g_range[0] is np.nan)
    #print("g_range[0]",g_range[0])
    if g_range[0] is np.nan:
        g_range[0] = np.min(img_obj.get_voxel_grid()[roi_obj.roi.get_voxel_grid()])
    if g_range[1] is np.nan:
        g_range[1] = np.max(img_obj.get_voxel_grid()[roi_obj.roi.get_voxel_grid()])
    
    #print("2 np is nan img_voxel_grid",np.isnan(img_voxel_grid).any())
    ...
    #print("g_range",g_range)
    #print("3 np is nan img_voxel_grid",np.isnan(img_voxel_grid).any())
    # Apply threshold
    img_voxel_grid[img_voxel_grid < g_range[0]] = g_range[0]
    img_voxel_grid[img_voxel_grid > g_range[1]] = g_range[1]
    #print("4 np is nan img_voxel_grid",np.isnan(img_voxel_grid).any())
    ...
    #print(img_voxel_grid.min(),img_voxel_grid.max())
    #print("g_range",g_range)
    ...
    #print(img_voxel_grid.min(),img_voxel_grid.max())
    #print("5 np is nan img_voxel_grid",np.isnan(img_voxel_grid).any())
    if img_voxel_grid.dtype not in ["float", "float64"]:
        img_voxel_grid = img_voxel_grid.astype(float)
   
    #print("img_voxel_grid",img_voxel_grid)
    #print("np is nan img_voxel_grid",np.isnan(img_voxel_grid).any())
